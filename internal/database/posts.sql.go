...
SELECT posts.id, posts.title, posts.url, posts.description, posts.feed_id, posts.created_at, posts.updated_at, posts.published_at, feeds.name AS feed_name FROM posts
